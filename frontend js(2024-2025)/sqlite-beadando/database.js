...
const initializeDB = async () => {
    ...
    const users = [
        { firstName: "John", lastName: "Doe", email: "john.doe@example.com", address: "Nyikos utca 36." },
        { firstName: "Jane", lastName: "Smith", email: "jane.smith@example.com", address: "Nyíl utca 4." },
        { firstName: "Sam", lastName: "Jhonson", email: "sam.johnson@example.com", address: "Uborka utca 69." },
    ];
